TARGETS = mountall.sh fake-hwclock mountkernfs.sh hostname.sh kmod udev keyboard-setup console-setup alsa-utils mountall-bootclean.sh mountnfs-bootclean.sh hwclock.sh mountdevsubfs.sh urandom networking x11-common procps udev-mtab
