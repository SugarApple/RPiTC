TARGETS = mountkernfs.sh fake-hwclock hostname.sh udev mountdevsubfs.sh keymap.sh keyboard-setup console-setup urandom mountall.sh hwclock.sh networking alsa-utils mountnfs.sh mountnfs-bootclean.sh checkroot.sh mountall-bootclean.sh udev-mtab kbd bootmisc.sh checkroot-bootclean.sh kmod procps mtab.sh checkfs.sh x11-common
