TARGETS = mountkernfs.sh fake-hwclock hostname.sh udev mountdevsubfs.sh keymap.sh keyboard-setup console-setup urandom mountall.sh hwclock.sh mountnfs.sh mountnfs-bootclean.sh networking alsa-utils checkroot.sh mountall-bootclean.sh bootmisc.sh udev-mtab kbd checkroot-bootclean.sh kmod procps mtab.sh checkfs.sh x11-common
