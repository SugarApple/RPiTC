...
## Package name      : perl5
## Source directory  : .
## Configuration time: Sun Nov  3 19:05:01 UTC 2013
## Configured by     : Debian Project
## Target system     : linux rpitc 3.0.80 #3 smp preempt tue may 28 10:14:48 utc 2013 armv7l gnulinux 
#
...
cf_time='Sun Nov  3 19:05:01 UTC 2013'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_argc='36'
config_args='-Dusethreads -Duselargefiles -Dccflags=-DDEBIAN -D_FORTIFY_SOURCE=2 -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security -Dldflags= -Wl,-z,relro -Dlddlflags=-shared -Wl,-z,relro -Dcccdlflags=-fPIC -Darchname=arm-linux-gnueabi -Dprefix=/usr -Dprivlib=/usr/share/perl/5.18 -Darchlib=/usr/lib/perl/5.18 -Dvendorprefix=/usr -Dvendorlib=/usr/share/perl5 -Dvendorarch=/usr/lib/perl5 -Dsiteprefix=/usr/local -Dsitelib=/usr/local/share/perl/5.18.1 -Dsitearch=/usr/local/lib/perl/5.18.1 -Dman1dir=/usr/share/man/man1 -Dman3dir=/usr/share/man/man3 -Dsiteman1dir=/usr/local/man/man1 -Dsiteman3dir=/usr/local/man/man3 -Duse64bitint -Dman1ext=1 -Dman3ext=3perl -Dpager=/usr/bin/sensible-pager -Uafs -Ud_csh -Ud_ualarm -Uusesfio -Uusenm -Ui_libutil -Uversiononly -DDEBUGGING=-g -Doptimize=-O2 -Duseshrplib -Dlibperl=libperl.so.5.18.1 -des'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
libspath=' /usr/local/lib /lib/arm-linux-gnueabi /lib /usr/lib/arm-linux-gnueabi /usr/lib'
...
myuname='linux rpitc 3.0.80 #3 smp preempt tue may 28 10:14:48 utc 2013 armv7l gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/arm-linux-gnueabi/4.8 /lib/arm-linux-gnueabi /lib /usr/lib/arm-linux-gnueabi/4.8 /usr/lib/arm-linux-gnueabi /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
